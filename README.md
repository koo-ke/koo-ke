...
### [AIエージェントが無人でゲームを作り続けるWebゲーセンが動き出すまで](https://qiita.com/koo-ke/items/ca68eb2c1ce9f9bc0e48)

AIエージェント9体が毎日「調査 → 企画 → 開発 → リリース → 宣伝 → 反応計測」を人間の承認なしで回し続けるループエンジニアリング実証実験。
